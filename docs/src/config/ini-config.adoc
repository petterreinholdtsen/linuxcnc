...
=== [HALUI] section[[sec:halui-section]](((INI File, HALUI Section)))
...
=== [APPLICATIONS] Section[[sec:applications-section]](((INI File, APPLICATIONS Section)))
...
=== [TRAJ] Section[[sec:traj-section]](((INI File, TRAJ Section)))

...
|<<sec:g88,G88>>                    |Boring Cycle, Stop, Manual Out '(not yet implemented)'
...
|<<gcode:g96-g97,G96>>              |Spindle Control Mode, Constant Surface Speed (IPM or m/min)
|<<gcode:g96-g97,G96>>              |Spindle Control Mode, Constant Rotation Speed (rpm) 
...
////
From _fr: Si un mouvement 'G0' déplace seulement des axes rotatifs et que la
...
image::images/g2_en.svg[align="center", alt="G2 Example"]
...
image::images/g2-3_en.svg[align="center", alt="G2-G3 Example"]
...
////
From _fr: Pour utiliser la compensation dynamique de longueur d'outil depuis un
...
[[gcode:g61]]
== G61 Exact Path Mode
(((G61 Exact Path Mode)))(((Trajectory Control)))
...
(((G61 Exact Stop Mode)))(((Trajectory Control)))
...
[[gcode:g64]]
== G64 Path Blending
(((G64 Path Blending)))(((Trajectory Control)))
...
[WARNING]
From _fr: Les valeurs inutilement hautes de dégressivité, produiront un nombre inutilement
...
From _fr: Les entrées et sorties de filetage peuvent être programmées coniques
...
image::images/g76-01.png["G76 Example Path, align="center""]
...
image::images/g81mult_en.svg["G80 Cycle", align="center"]
...
drilling ormilling with chip breaking. The retracts in this cycle clear the hole

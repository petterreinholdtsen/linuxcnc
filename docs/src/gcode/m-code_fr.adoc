...
[[sec:M0-M1]]
== M0, M1, pauses dans le programme
(((M0, M1, pauses dans le programme)))(((M0 Pause dans le programme)))(((M1 Pause optionnelle dans le programme)))
...
(((M2 Fin de programme)))(((M30 Fin de programme avec déchargement pièce)))
...
(((M3 Broche en sens horaire)))(((M4 Broche en sens anti-horaire)))(((M5 Arrêt de broche)))
...
(((M7 Arrosage gouttelettes)))(((M8 Arrosage fluide)))(((M9 Arrêt des arrosages)))
...
C'est une erreur de programmer 'M66' avec à la foisun mot P- et un mot E- (ce qui reviendrait à sélectionner à la fois une
...
Si nécessaire, le nombre des entrées/sorties peut être augmenté enutilisant les paramètres 'num_dio' ou 'num_aio' lors du chargement du
...
(((M100 à M199 M-codes définis par l'utilisateur)))(((M-codes définis par l'utilisateur M100-M199)))

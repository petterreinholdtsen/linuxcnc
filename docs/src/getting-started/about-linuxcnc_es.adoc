...
* Configure su cuenta IRC con su nombre único para que las personas sepan quién es usted. Si usa el cliente java, use el mismo nombre cada vez que inicie sesión.

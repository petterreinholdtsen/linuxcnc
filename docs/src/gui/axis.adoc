...
* From _fr: 'Coordonnées en police large...' - Les coordonnées des axes et la vitesse
...
From _fr: Voir aussi les options du menu Machine: 'Toucher la pièce' et 'Toucher le porte-pièce'.

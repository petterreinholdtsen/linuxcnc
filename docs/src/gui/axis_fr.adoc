...
qui permettent d'augmenter ou de diminuer la vitesse de la fonction concernée.
FIXME The default maximum is 120% and can be set to a different
...
bouton droit enfoncé, ou encore en glissant la souris avec son bouton gauche enfoncé et la touche 'Ctrl' appuyée, le tracé sera zoomé en plus ou en moins.
...
.Fenêtre de changement d'outil manuel
...
(((AXIS: Panneau de contrôle virtuel)))

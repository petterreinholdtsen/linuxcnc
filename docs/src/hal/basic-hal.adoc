...
From _fr: La commande 'addf' ajoute une fonction à un thread temps réel. Si
...
== From _fr: Composants de conversion

=== From _fr: Somme pondérée  (weighted_sum)

From _fr: La somme pondérée converti un groupe de bits en un entier. La conversion est la
...
From _fr: La syntaxe suivante est utilisée pour charger le composant weighted_sum.

----
loadrt weighted_sum wsum_sizes=size[,size,...]
----

From _fr: Crée des groupes de weighted_sum, chacun avec le nombre donné de bits d'entrée (size).

From _fr: Pour mettre à jour la weighted_sum, le process_wsums doit être attaché à un thread.

----
addf process_wsums servo-thread
----

From _fr: Ce qui met à jour le composant weighted_sum.

From _fr: Dans l'exemple suivant, une copie de la fenêtre de configuration de HAL d'Axis,
